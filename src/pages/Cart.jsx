      ...
      <div className='grid grid-cols-3 gap-4 mt-5'>
          ...
          <table className='table-auto w-full'>
            ...
            <tbody>
              <tr>
                <td>1</td>
                <td>Product Name</td>
                <td><img width={`70px`} height={`70px`} src="https://tse1.mm.bing.net/th?id=OIP.MHcsjkvXVy4nb4KvZEZyqQHaHa&pid=Api&P=0&h=180" alt="" /></td>
                <td>
                  <div className='flex'>
                    <button className='font-bold'>-</button>
                    <input style={{width:'40px'}} className='border p-1 rounded mx-2' type="text" value={2} readOnly />
                    <button className='font-bold'>+</button>
                  </div>
                </td>
                <td>$25</td>
        ...
        <div className="col-span-1">
          <div className="border rounded shadow p-5">
            <h2 className="text-2xl font-bold my-4">Total Amount : <span className='text-red-600'>$25</span></h2>
